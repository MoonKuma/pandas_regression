...
# col
# x_columns = pick_columns(columns=columns, word_starts_with='rest_norm_')
# y_column = pick_columns(columns=columns, word_starts_with='RESULT_r7')
def train_and_test(df, x_columns, y_column,  test_size = 0.1, test_times = 10, model_set= model_set_1):
    """
    ...
    :param model_dict:  machine learning models used
    ...
    for model_name in model_dict.keys():
        ...
        if  result_train_dict[model_name]<0:
            result_train_dict[model_name] = 0
    return result_test_dict, result_train_dict
